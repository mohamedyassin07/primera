    ...
    class PRIMERA_Profit_Tax_Functionality {
        ...
        public function change_order_tax($and_taxes, $order) {
            ...
            if($order->get_user()){
                ...
                require_once dirname( WC_THEME_FILE ) . '/includes/wc-cart-functions.php';
        ...
        public function alter_price_according_to_currency($raw_price, $variation_id, $product_id) {
            $current_gateway = isset( WC()->session->chosen_payment_method )? WC()->session->chosen_payment_method : '';
            if ('' != $current_gateway) {
